...
const en: Translations = {
  ...
  recurring_suggestions_subtitle: "Same merchant, exact same amount, around the same day (±3) in all of the last 3 months",
...
const he: Translations = {
  ...
  recurring_suggestions_subtitle: "אותו בית עסק, אותו סכום בדיוק, ובערך אותו יום בחודש (±3) בכל אחד מ־3 החודשים האחרונים",
